...
class TestHeader:
    ...
    def test_swag_labs_title_shown(self, page: Page, product_page):
    ...
    @allure.title(
        'Проверить, что кнопка "Back to Products" редиректит пользователя на страницу Inventory Page.'
    )
    def test_back_to_products_button_leads_to_inventory_page(
        self, page: Page, product_page
    ):
...
class TestHamburgerMenu:
    ...
    def test_check_hamburger_option_has_correct_text(
        self, page: Page, product_page, option
    ):
    ...
    def test_logout_option_leads_to_logout_page_and_logout_user(
        self, page: Page, product_page
    ):
        product_page.open_hamburger_menu()
    ...
    def test_reset_app_state_option_remove_product_from_cart(
        self, page: Page, product_page
    ):
        product_page.open_hamburger_menu()
    ...
    def test_close_hamburger_menu(self, page: Page, product_page):
        product_page.open_hamburger_menu()
        product_page.check_close_hamburger_menu_button_shown()
        product_page.close_hamburger_menu()
        product_page.check_hamburger_menu_closed()
...
class TestCart:
    ...
    @allure.title("Проверить, что корзина с продуктами успешно открывается.")
    def test_open_cart_with_product(self, page: Page, product_page, expand_description):
        product_page.add_product_to_cart()
        product_page.open_cart()
        product_page.check_cart_page_opened_with_correct_product_data(
            expand_description
        )
...
class TestProduct:
    ...
    def test_product_description_shown(
        self, page: Page, product_page, expand_description
    ):
    ...
    @allure.title(
        'Проверить, что отображается кнопка "Add to cart", если продукт не в корзине.'
    )
    ...
    def test_add_to_cart_button_appear(self, page: Page, product_page):
        product_page.add_product_to_cart()
        product_page.remove_product_from_cart()
        product_page.check_add_to_cart_button_has_text_("Add to cart")
...
class TestFooter:
    ...
    def test_terms_of_service_has_text(self, page: Page, product_page):
        product_page.check_terms_of_service_has_text_(
