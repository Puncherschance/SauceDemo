...
class TestCart:
    ...
    def test_continue_shopping_button_leads_to_inventory_page(self, page: Page, auth_as_standard_user, open_basket_page):
        basket_page = BasketPage(page)
        basket_page.check_continue_shopping_button_has_text_('Continue Shopping')
        basket_page.check_continue_shopping_button_leads_to_inventory_page()
...
class TestFooter:
    ...
    def test_twitter_icon_leads_to_twitter_page(self, page: Page, auth_as_standard_user, open_basket_page):
        basket_page = BasketPage(page)
        basket_page.check_twitter_icon_redirect()

    def test_terms_of_service_has_text(self, page: Page, auth_as_standard_user, open_basket_page):
        basket_page = BasketPage(page)
        basket_page.check_terms_of_service_has_text_('© 2024 Sauce Labs. All Rights Reserved. Terms of Service | Privacy Policy')